...
def _extract_keywords_ollama(
    ...
    # === Optimized fast prompt (from 2026-05 migration improvements) ===
    # Extremely directive, low token, forces quick comma list. Much faster on small local models.
    prompt = (
        "You are a precise keyword tagger for an AI skill marketplace search index.\n\n"
