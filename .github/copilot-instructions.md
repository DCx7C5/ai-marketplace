...
Use flat hyphenated skill directories and keep the skill name aligned with its directory.
...
Use scripts/refresh-flat-index.sh for one-shot flat-index check, index regeneration, hash update, and validation.
